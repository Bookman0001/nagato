...
const resources = {
  ja: {
    translation: {
      ...
      title: 'k工房',
      introduction:
        'フロントエンドをメインにエンジニアリングをしています。<0 />直近で最も得意としているのはTypeScriptとReactによるコンポーネント設計です。<0 />他に保守レベルでのバックエンドでのエンジニアリング、AWS運用も経験があります。<0 />一貫性のあるユーザービリティの高いシステムを追求し続けています。',
      oss: 'ドキュメント、コードで貢献しているOSS',
      step1:
        '医療システムパッケージウェアのうち画面と帳票部分の開発や改修を主に行っていました。<0 />また、SEという形でお客の打ち合わせ、仕様策定など各種業務経験も培いました。',
      step2:
        'web企業のエンジニアとして転向、<0 />フルスタックとして幅広く知識が要求される現場だったので多くの貴重な経験を積めました。',
      column21: '・SPAチャットアプリケーション作成',
      column22: '・複数ECサイトの保守・CMSの導入など',
      column23: '・某ユーザーサイトのフロントエンド新規開発',
      now: '現在は専門領域をフロントエンドとして日々開発に勤しんでいます。',
      column31: '・自社webサービスのフロントエンド新規開発',
    },
  },
  en: {
    translation: {
